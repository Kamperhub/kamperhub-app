...
5.  **CRITICAL - Set Redirect URI:**
    ...
    *   **DO NOT** add anything to the "Authorized JavaScript origins" section. This is for the main site URL only and does not allow paths.
    *   Scroll down to the **"Authorized redirect URIs"** section.
    *   Click **"+ ADD URI"**.
    *   Paste the **full URL** of your application's preview window, followed by `/api/auth/google/callback`.
    *   **Example:** `https://your-unique-id.cloudworkstations.dev/api/auth/google/callback`
    *   Click **Save**.
