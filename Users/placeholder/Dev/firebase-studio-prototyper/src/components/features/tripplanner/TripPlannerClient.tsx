    ...
    try {
        const response = await fetch('/api/directions/route', {
            ...
            body: JSON.stringify({
                ...
                vehicleHeight: activeVehicle?.overallHeight ? activeVehicle.overallHeight / 1000 : undefined,
                caravanHeight: activeCaravan?.overallHeight ? activeCaravan.overallHeight / 1000 : undefined,
                axleCount: axleCount,
