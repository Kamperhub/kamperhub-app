            ...
            <div className="container mx-auto px-4 text-center">
                 ...
                 <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                     <div className="bg-card border p-6 rounded-lg shadow-sm text-left">
                         <h3 className="font-headline text-xl flex items-center">Google Tasks (Optional)</h3>
                     ...
                     <div className="bg-card border p-6 rounded-lg shadow-sm text-left">
                         <h3 className="font-headline text-xl flex items-center">Google Calendar (Optional)</h3>
                         <p className="mt-2 text-muted-foreground">
