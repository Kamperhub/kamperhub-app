...
import { Home, Settings, Backpack, ListChecks, BookOpen, Route, History, BedDouble, CreditCard, BarChart3 } from 'lucide-react'; // Added BarChart3
...
export const navItems: NavItem[] = [
  ...
  { href: '/stats', label: 'Travel Stats', icon: BarChart3, keywords: 'trips summary insights achievement' }, // New Item
