...
// The Firebase client will use the specific key provided by the Firebase Console.
// This key MUST be configured in the Google Cloud Console with the correct API and website restrictions.
