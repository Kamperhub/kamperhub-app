...
// This uses a dedicated API key for Firebase services, found in your Firebase project's General settings.
// It is separate from the Google Maps key to avoid conflicts with API key restrictions.
