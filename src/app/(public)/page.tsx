    ...
    <div className="bg-background font-body">
      <main>
        ...
        <section className="text-center py-12 md:py-20 px-4">
          <Image
            src="https://firebasestorage.googleapis.com/v0/b/kamperhub-s4hc2.firebasestorage.app/o/KamperHub%20512x512.jpg?alt=media&token=00bf2acd-dbca-4cc2-98461f67fdbd"
            alt="KamperHub Logo"
            width={120}
            height={120}
