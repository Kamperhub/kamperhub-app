...
export const sampleAffiliateLinks: AffiliateLink[] = [
  ...
  },
  {
    ...
    url: 'https://www.nationalparks.nsw.gov.au/camping-and-accommodation',
    description: 'Official site for booking camping and accommodation in New South Wales parks.',
    dataAiHint: 'new south wales park',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
    ...
    description: 'Book campsites, roofed accommodation, and other experiences in Victoria.',
    dataAiHint: 'victoria park camping',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
    ...
    description: 'Official booking website for South Australia\'s National Parks.',
    dataAiHint: 'south australia park',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
    id: 'waParks',
    name: 'Parks and Wildlife WA',
    url: 'https://exploreparks.dbca.wa.gov.au/',
    description: 'Official site for campsite bookings in Western Australian parks.',
    dataAiHint: 'western australia park',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
    id: 'tasParks',
    name: 'Parks & Wildlife TAS',
    url: 'https://parks.tas.gov.au/things-to-do/camping',
    description: 'Information and booking portal for camping in Tasmania\'s parks.',
    dataAiHint: 'tasmania park camping',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
    id: 'ntParks',
    name: 'Parks and Wildlife NT',
    url: 'https://depws.nt.gov.au/parks-and-wildlife-commission/booking-and-permits/parks-and-reserves-for-online-bookings',
    description: 'Online booking for parks and reserves in the Northern Territory.',
    dataAiHint: 'northern territory park',
    icon: Trees,
    category: 'Government & National Parks',
  },
  {
