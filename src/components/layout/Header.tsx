    ...
    <header className="bg-primary text-primary-foreground shadow-md sticky top-0 z-40">
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between h-[68px]">
        <Link href={homeLink} className="flex items-center" onClick={handleNavigation}>
          <Image
            src="https://firebasestorage.googleapis.com/v0/b/kamperhub-s4hc2.appspot.com/o/KamperHubMedia%2FKamperHub%20logo%20180x60.png?alt=media&token=0ba20d31-3733-4453-aaad-639a5babe95c"
