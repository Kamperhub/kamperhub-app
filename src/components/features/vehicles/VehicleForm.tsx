...
export function VehicleForm({ initialData, onSave, onCancel, isLoading }: VehicleFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="p-4 border rounded-md space-y-4 bg-muted/30">
        ...
        {watchedGvm > 0 && !watchedKerbWeight && (
           <Alert variant="default" className="mt-2 bg-muted/50 border-muted/80">
              ...
              <AlertDescription className="font-body text-muted-foreground/80 text-xs">
      ...
      <Separator />
      <h3 className="text-lg font-medium font-headline text-primary">Storage Locations (Optional)</h3>
      <div className="space-y-3">
          ...
          <div key={field.id} className="p-3 border rounded-md space-y-2 bg-muted/30">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <Input {...register(`storageLocations.${index}.maxWeightCapacityKg`)} type="number" placeholder="e.g., 50" className="font-body bg-background text-sm h-9"/>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <div>
                    ...
                    <Input {...register(`storageLocations.${index}.distanceFromRearAxleMm`)} type="number" placeholder="e.g., 500 (front)" className="font-body bg-background text-sm h-9"/>
                ...
                <div>
                    ...
                    <Input {...register(`storageLocations.${index}.distanceFromCenterlineMm`)} type="number" placeholder="e.g., -200 (left)" className="font-body bg-background text-sm h-9"/>
                ...
                <div>
                    ...
                    <Input {...register(`storageLocations.${index}.heightFromGroundMm`)} type="number" placeholder="e.g., 400" className="font-body bg-background text-sm h-9"/>
        ...
        <Button type="button" variant="outline" size="sm" onClick={() => append({ id: Date.now().toString(), name: '', longitudinalPosition: 'between-axles', lateralPosition: 'center', distanceFromRearAxleMm: null, distanceFromCenterlineMm: null, heightFromGroundMm: null, maxWeightCapacityKg: null } as VehicleStorageLocation)} className="font-body text-xs">
